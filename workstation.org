...
- [ ] update workstation.org so it compiles cleanly (no file drift)
- [ ] rebuild belthronding (lots of manual hacking)
- [ ] get nix-doom-emacs back in system
- [ ] add a CI step that ensures workstation.org compiles cleanly
