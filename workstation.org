...
#+end_src
* TODO checklist
- [ ] get rid of hardcoded things for glamdring. add support for other machines
- [ ] can I get rid of having home manager use a channel for install?
...
- [X] update workstation.org so it compiles cleanly (no file drift)
- [ ] rebuild belthronding (lots of manual hacking)
- [X] get nix-doom-emacs back in system
- [ ] add a CI step/check that ensures workstation.org compiles cleanly
- [ ] document what I learned about snap and emacs and installing it etc
- [ ] document what I learned about emacs in snap (how it can't access certain
  files? in /tmp I think? not very useful!)
...
** quick planning (in rough order need to complete, to get to next phase of project)
